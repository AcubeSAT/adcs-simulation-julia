...
function solar_radiation_pressure(R_OB, sun_vector, cm)
    ...
    # Change: Make this a vector, not a matrix
    ...
    # Why do we use different type from the DDJF, the question is about the cross function and the cos(i) which does not exists
