...
function gravity_gradient_tensor(model, p, t, max_degree, P, dP; δ=1e-3)
    ...
    for i in 1:3
        ...
        g_backward = CartesianFromSpherical()(
            Spherical(
                GravityModels.gravitational_field_derivative(
                    model,
                    [
...
function gravity_torque(G_ecef, R_ecef_to_body, I)
    ...
    T1 =
        G_body[2, 3] * (I[3, 3] - I[2, 2]) + G_body[1, 3] * I[1, 2] -
        G_body[1, 2] * I[1, 3] + I[2, 3] * (G_body[3, 3] - G_body[2, 2])
    T2 =
        G_body[1, 3] * (I[1, 1] - I[3, 3]) - G_body[2, 3] * I[1, 2] +
        G_body[1, 2] * I[2, 3] +
        I[1, 3] * (G_body[1, 1] - G_body[3, 3])
    T3 =
        G_body[1, 2] * (I[2, 2] - I[1, 1]) + G_body[2, 3] * I[1, 3] -
        G_body[1, 3] * I[2, 3] + I[1, 2] * (G_body[2, 2] - G_body[1, 1])
